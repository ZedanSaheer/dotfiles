...
import { Header, Redirect, Rewrite } from 'next/dist/lib/load-custom-routes-routes';
import { ImageConfig, ImageConfigComplete, RemotePattern } from 'next/dist/shared/lib/image-config-config';
