...
export const isValueNullShowPlaceholder = (value: string | string [] | null | boolean | undefined) => {
...
export const isArrayNullShowPlaceholder = (value: string | string [] | null | boolean | undefined) => {
    //Returns a placeholder text if value is falsy
    if (!value) {
        return "No Information Yet"
    } else {
