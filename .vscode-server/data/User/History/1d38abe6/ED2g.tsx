    ...
    return (
        <div className={`page aligned-center ${styles.index}`}>
            ...
            <div className={styles.info_wrapper}>
                <div> <h1>Name</h1> : <span>{guild.name}</span></div>
                <div><h1>Permissions</h1> : <span>{guild.permission}</span></div>
                <div><h1>Features</h1> : <span>{guild.features}</span></div>
                <div><h1>Owner</h1> : <span>{guild.owner}</span></div>
            </div>
        </div>
