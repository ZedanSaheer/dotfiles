...
import { __ApiPreviewProps } from 'next/dist/server/api-utilserver/api-utils';
...
import type { DynamicRoutes, PageChecker, Route } from 'next/dist/server/routert/server/router';
...
import type { RouteMatch } from 'next/dist/shared/lib/router/utils/route-matchermatcher';
import type { Params } from 'next/dist/shared/lib/router/utils/route-matchermatcher';
import type { NextConfig, NextConfigComplete, ServerRuntime } from 'next/dist/server/config-sharedr/config-shared';
...
import { PrerenderManifest } from 'next/dist/buildt/build';
...
export { stringifyQuery } from 'next/dist/server/server-route-utilsver-route-utils';
